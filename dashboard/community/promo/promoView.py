...
class promoViewClass:
    ...
    def getPromoContent(self, data, bgImage):
        content = [dbc.Card(dbc.CardBody([html.H4(['Community Project: DefiChain Promo']),
                                          ...
                                          dcc.Graph(figure=self.createPromoDatebaseFigure(data, bgImage), id='figurePromoDatabase', config={'displayModeBar': False})]))]
        return content

    @staticmethod
    def createPromoDatebaseFigure(data, bgImage):
