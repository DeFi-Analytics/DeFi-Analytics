...
class arbitrageViewClass:

    def getArbitrageContent(self):
        content = [dbc.Modal([dbc.ModalHeader("Info DEX Coinprice"),
                              dbc.ModalBody(self.getArbitrageExplanation()),
                              dbc.ModalFooter(dbc.Button("close", id="closeInfoArbitrage", className="ml-auto"))], id="modalArbitrage", size='xl'),
                   dbc.Card(dbc.CardBody([html.H4(['Coinprices on DEX and other exchanges']),
                                          ...
                                          html.Td(dcc.Dropdown(id='dexArbitrageReference', options=[{'label': 'Coingecko', 'value': 'Coingecko'},
                                          ...
                                          html.Td(dcc.Dropdown(id='dexArbitrageCoin', options=[{'label': 'BTC', 'value': 'BTC'},
                                                                                            {'label': 'ETH', 'value': 'ETH'},
                                          ...
                                          dbc.Row([dbc.Col(dcc.Graph(id='figureArbitrageLongterm', config={'displayModeBar': False}), lg=7, xl=8, align='start'),
                                                   dbc.Col(dcc.Graph(id='figureArbitrageShortterm', config={'displayModeBar': False}), lg=5, xl=4)], no_gutters=True),
