    ...
    def getAppIndexString():
        ...
        <html>
            <head> 
                ...
                <meta property="og:image" content="https://www.defichain-analytics.com/static/images/logo-defi-analytics_blackBackground.png">
                ...
                <meta name="twitter:image" content="https://www.defichain-analytics.com/static/images/logo-defi-analytics_twitterCard.png">
                {%favicon%}
                {%css%}
            </head>
            <body>
